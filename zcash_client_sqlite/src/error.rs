...
impl std::fmt::Display for SqliteClientError {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match &self {
            ...
            SqliteClientError::RequestedRewindInvalid(h, r) =>
                write!(f, "A rewind must be at least back to block {} for your wallet; the requested height was {}.", h, r),
...
/*impl From<rusqlite::Error> for std::fmt::Error {
    fn from(e: rusqlite::Error) -> Self {
        std::fmt::Error(e)
    }
}*/
